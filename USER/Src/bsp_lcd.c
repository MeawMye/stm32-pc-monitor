...
static void LCD_BriefDisplay(void)
{
  ...
  BSP_LCD_FillRect(0, 0, 800, 200);
  BSP_LCD_SetTextColor(LCD_COLOR_BLACK);
  BSP_LCD_FillRect(0, 200, 800, 280);
  BSP_LCD_SetBackColor(LCD_COLOR_GREEN);
  BSP_LCD_DisplayStringAtLine(1, (uint8_t *)"           PC to STM32 LCD");
  BSP_LCD_SetFont(&Font16);
  BSP_LCD_DisplayStringAtLine(4, (uint8_t *)"This test shows how to display system values on LCD DSI using two buffers");
